...
<main class="main">
    <!-- form section -->
    <form action="{{  route('user.store')  }}" class="form">
        <h2 class="form__section-title">ログイン</h2>
        @csrf
        <div class="user-name">
            <input type="text" class="name__input" placeholder="ユーザーネーム">
        </div>
        <div class="email">
            <input type="email" class="email__input" placeholder="メールアドレス">
        </div>
        <div class="password">
            <input type="password" class="password__input" placeholder="パスワード">
        </div>
        <!-- button -->
