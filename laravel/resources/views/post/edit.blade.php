...
<main class="main">
    ...
    <form action="{{  route('post.store')  }}" class="form" method="post">
        ...
        <div class="name">
            ...
            <input type="string" name="friend_name" class="name__input" value="{{  $posts->friend_name }}">
        </div>
        <div class="memo">
            ...
            <textarea type="text" name="memo" id="" cols="30" rows="10" class="memo__input">{{  $posts->memo }}</textarea>
        </div>
        <!-- button -->
